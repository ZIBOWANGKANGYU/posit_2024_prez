...
## GitHub Copilot {auto-animate="true"}

-   GitHub, OpenAI, Microsoft
-   Productivity boost

::: footer
["The Productivity Effects of Generative AI: Evidence from a Field Experiment with GitHub Copilot"](https://mit-genai.pubpub.org/pub/v5iixksv/release/2)

["Sea Change in Software Development: Economic and Productivity Analysis of the AI-Powered Developer Lifecycle”](https://github.blog/2023-06-27-the-economic-impact-of-the-ai-powered-developer-lifecycle-and-lessons-from-github-copilot/)
...
## Shiny is a pain because ... {auto-animate="true"}
...
``` r
# Create a beautiful stock price tracking application using a 
# table and a chart. The UI should allow users to select one or 
# multiple stocks. It should show a table with information about
# all selected stocks, and a line chart showing price changes over 
# time.
```
...
-   Specific Know the package / function you want to use If not sure, ask Copilot

-   Question as a prompt

``` {.r code-line-numbers="1"}
# Please don't provide code but give answer in English. 
# What packages in R provide functionality for selection inputs? The user need to select one or a few stock tickers. 
...
# Answer: the shinyWidgets package provides the selectInput function for selection inputs. 
```
...
::: {layout="[1, 20]"}
![](images/fundamental_workflow){width="41"}
